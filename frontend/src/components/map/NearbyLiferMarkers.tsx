  ...
  return (
    <>
      ...
      {selLoc && (
        ...
        // lib/tabOrderCoverage.test.ts. closeOnClick stays false: only the close
        // control changes owner.
        <Popup longitude={selLoc.lng} latitude={selLoc.lat} anchor="bottom" offset={14} onClose={() => onSelect(null)} closeButton={false} maxWidth="min(280px, 80vw)" closeOnClick={false}>
