...
// The plist and project.yml readers live in ../test/appleManifest.ts (moved
// there verbatim at ios-lifer-widgets so iosWidgetManifest.test.ts can share
// them); their guard-the-guard rows stay below.
