...
- **Filters:** pills 30px/15px-radius (`aria-pressed`), accent positive state,
  ...
  iOS-safe scale-tracking size, a genuine floor since vX.Y.Z
  ...
  sized in relation to it, not left behind (vX.Y.Z):** a label beside a floored
